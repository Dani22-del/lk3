						...
						<div role="tabpanel" class="tab-pane active" id="general">
							<div class="table-responsive">
								<table class="table table-striped table-hover table-setting">
									...
									<tr>
										<td style="width:265px;">Email 1</td>
										<td class="link-setting">
									...
									<tr>
										<td style="width:265px;">Email 2</td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="email_1" data-type="text" data-pk="33" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[32]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;">Email 3</td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="email_2" data-type="text" data-pk="34" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[33]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;">Email 4</td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="email_3" data-type="text" data-pk="35" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[34]['value'];?></a>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td style="width:265px;">WhatsApp LK3</td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="whatsapp_1" data-type="text" data-pk="31" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[30]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;">WhatsApp Eleska</td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="whatsapp_2" data-type="text" data-pk="32" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[31]['value'];?></a>
										</td>
									</tr>
								</table>
							</div>
