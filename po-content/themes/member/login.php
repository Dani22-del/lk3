			...
			<div class="col-md-12">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-6">
						<a href="<?=BASE_URL;?>/member/login/facebook" class="btn btn-fb btn-block btn-flat"><i class="fa fa-facebook"></i>&nbsp;&nbsp;<?=$this->e($front_member_login_fb);?></a>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6">
						<a href="<?=BASE_URL;?>/member/login/twitter" class="btn btn-tw btn-block btn-flat"><i class="fa fa-twitter"></i>&nbsp;&nbsp;<?=$this->e($front_member_login_tw);?></a>
					</div>
				</div>
				<div class="login-or">
				...
				<form role="form" id="login-form" method="post" action="<?=BASE_URL;?>/member/login">
					<div class="form-group">
						<label for="username"><?=$this->e($front_member_username);?> / <?=$this->e($front_member_email);?>gdfgdf</label>
					...
					<button type="submit" class="btn btn btn-success btn-flat"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;<?=$this->e($front_member_login);?></button>
				</form>
				<div class="login-or">
					<hr class="hr-or"><span class="span-or"><?=$this->e($front_member_or);?></span>
				</div>
				<div class="row">
					<div class="col-md-12">
						<a href="<?=BASE_URL;?>/member/register" class="btn no-bg btn-block"><i class="fa fa-user"></i>&nbsp;&nbsp;<?=$this->e($front_member_register);?></a>
					</div>
				</div>
			</div>
		</div>
