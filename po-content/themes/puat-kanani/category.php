			...
			<div class="cs-container">
                ...
                <div class="cs-main-content cs-sidebar-on-the-right">
                    ...
                    <div class="cs-post-block-layout-4">
                        <!-- Post item -->
						<?php
							$categorys = $this->post()->getPostFromCategory('10', 'id_post_category DESC', 'post.id_post DESC', $category, $this->e($page), WEB_LANG_ID);
							foreach($categorys as $post){
								$post_category = $this->category()->getCategory($post['id_post'], WEB_LANG_ID);
						?>
